...
module.exports = function (command) {
  ...
  function show(command) {
    ...
    return contacts
      .sort()
      .map((tel) => (tel.indexOf(",") !== -1 ? tel.split(",").join(", ") : tel));   //возвращаем отсортированный по алфавиру массив контактов, где все телефонные номера разделены не только запятой, но и пробелом
  }
}